...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">Request Coaching</div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('pegawai.imtak-pengawasan.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="detail" name="detail" class="form-control shadow-none @error('detail') is-invalid @enderror" rows="5"></textarea>
                                @error('detail')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
